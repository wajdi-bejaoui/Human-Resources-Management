...
function navbar() {
  ...
  {/* <div class="px-3 mb-6  mx-auto w-11/12 bg-white rounded-xl"> */}
    ...
    <div class="relative flex items-center lg:ml-4 sm:mr-0 mr-2">
        ...
        <input class="block w-full min-w-[70px] py-3 pl-12 pr-4 text-base font-medium leading-normal bg-white border border-solid outline-none appearance-none placeholder:text-secondary-dark peer text-stone-900 border-gray-500 bg-clip-padding rounded-2xl" placeholder="Search..." type="text" />
