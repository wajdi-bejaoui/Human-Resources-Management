  ...
  {/* <div className="px-3 mb-6  mx-auto w-11/12 bg-white rounded-xl"> */}
    ...
    <div className="relative flex items-center lg:ml-4 sm:mr-0 mr-2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"></path>
        </svg>
        </span>
        <input className="block w-full min-w-[70px] py-3 pl-12 pr-4 text-base font-medium leading-normal bg-white border border-solid outline-none appearance-none placeholder:text-secondary-dark peer text-stone-900 border-gray-500 bg-clip-padding rounded-2xl" placeholder="Search..." type="text" />
    ...
    <div className="relative flex items-center ml-2 lg:ml-4">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <path strokeLinecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
        </svg>
        </a>
    </div>
    <div className="relative flex items-center ml-2 lg:ml-4">
